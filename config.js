module.exports = {
    ...
    /*
    HANDLER_INFOS: [
        {file:'./RPC/board', method:'submitBoard'}
        ,{file:'./RPC/board', method:'deleteBoard'}
        ,{file:'./RPC/notice', method:'submitNotice'}
        ,{file:'./RPC/notice', method:'deleteNotice'}
        ,{file:'./RPC/volunteer', method:'createCenter'}
        ,{file:'./RPC/volunteer', method:'applyCenter'}
        ,{file:'./RPC/volunteer', method:'deleteCenter'}
        ,{file:'./RPC/develop', method:'createProject'}
        ,{file:'./RPC/develop', method:'applyProject'}
        ,{file:'./RPC/develop', method:'deleteProject'}
    ],
    */
    ROUTE_INFOS: [
            ...
            ,{file: './Controller/user', path: '/signin', method: 'authorize_user', type:'post'}
            ,{file: './Controller/user', path: '/signup', method: 'render_signUp', type:'get'}
            ,{file: './Controller/user', path: '/signup', method: 'register_user', type:'post'}
            ,{file: './Controller/user', path: '/logout', method: 'logout_user', type:'get'}
